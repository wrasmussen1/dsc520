...
person_df1 <- read.csv("/Users/wrasmussen/Desktop/MastersOfDataScience/DSC520/week2/dsc520/data/tidynomicon/person.csv", header=TRUE, sep = ",")
str(person_df1)
...
person_df2 <- read.csv("/Users/wrasmussen/Desktop/MastersOfDataScience/DSC520/week2/dsc520/data/tidynomicon/person.csv", header=TRUE, sep = ",", stringsAsFactors = FALSE)
str(person_df2)

## Read the file `data/scores.csv` to `scores_df`
## Display summary statistics using the `summary()` function
scores_df <- read.csv("/Users/wrasmussen/Desktop/MastersOfDataScience/DSC520/week2/dsc520/data/scores.csv", header=TRUE, sep = ",")
summary(scores_df)
...
excel_sheets("/Users/wrasmussen/Desktop/MastersOfDataScience/DSC520/week2/dsc520/data/G04ResultsDetail2004-11-02.xls")
...
voter_turnout_df1 <- read_excel("/Users/wrasmussen/Desktop/MastersOfDataScience/DSC520/week2/dsc520/data/G04ResultsDetail2004-11-02.xls", skip=1)
...
voter_turnout_df2 <- read_excel("/Users/wrasmussen/Desktop/MastersOfDataScience/DSC520/week2/dsc520/data/G04ResultsDetail2004-11-02.xls", skip=2, col_names = TRUE)
